# 2026-06-08 前端 工作台 接线

## 目标

本计划记录 `frontend-workbench-wiring` 相关工作的实现意图、边界和验证方式。该工作服务于本地知识库 Agent / Advanced RAG 项目，要求保持前端、Spring Boot 与 FastAPI 的职责边界清晰。
...
- 根据 `frontend-workbench-wiring` 的主题更新对应服务、测试或文档。
